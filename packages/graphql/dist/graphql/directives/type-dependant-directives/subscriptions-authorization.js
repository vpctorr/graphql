...
import { DirectiveLocation, GraphQLBoolean, GraphQLDirective, GraphQLInputObjectType, GraphQLList, GraphQLNonNull, GraphQLSchema, GraphQLString, } from "graphql";
...
export function createSubscriptionsAuthorizationDefinitions(typeDefinitionName, schema) {
    ...
    const subscriptionsAuthorizationWhereAST = astFromInputObjectType(subscriptionsAuthorizationWhere, subscriptionsAuthorizationSchema);
    const subscriptionsAuthorizationFilterRuleAST = astFromInputObjectType(subscriptionsAuthorizationFilterRule, subscriptionsAuthorizationSchema);
