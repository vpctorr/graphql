...
export function parseArgumentsFromUnknownDirective(directive) {
 ...
 * Object prototype.
 */
export function parseArguments(def, node, variableValues) {
    const coercedValues = {};
        ...
        if (valueNode.kind === Kind.VARIABLE) {
            ...
            if (variableValues == null || !Object.prototype.hasOwnProperty.call(variableValues, variableName)) {
                if (argDef.defaultValue !== undefined) {
                    ...
                    throw new Error(`Argument "${name}" of required type "${inspect(argType)}" ` +
