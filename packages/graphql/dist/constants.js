...
export function isTemporal(typeName) {
    return TEMPORAL_SCALAR_TYPES.includes(typeName);
}
export function isSpatial(typeName) {
...
export var RelationshipQueryDirectionOption;
...
})(RelationshipQueryDirectionOption || (RelationshipQueryDirectionOption = {}));
export var RelationshipNestedOperationsOption;
...
})(RelationshipNestedOperationsOption || (RelationshipNestedOperationsOption = {}));
...
export const PROPAGATED_DIRECTIVES = [SHAREABLE, DEPRECATED];
