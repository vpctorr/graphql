...
export function subscriptionsAuthorizationDefinitionsEnricher(enricherContext) {
    return definitionsEnricher(enricherContext, "subscriptionsAuthorization", createSubscriptionsAuthorizationDefinitions);
}
// Enriches the applied directives on objects, interfaces and fields
export function subscriptionsAuthorizationDirectiveEnricher(enricherContext) {
