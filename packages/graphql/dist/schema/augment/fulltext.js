...
import { withFullTextInputType, withFullTextResultType, withFullTextSortInputType, withFullTextWhereInputType, } from "../generation/fulltext-input";
import { fulltextResolver } from "../resolvers/query/fulltext";
export function augmentFulltextSchema(node, composer, concreteEntityAdapter) {
