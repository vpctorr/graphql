...
export function withFullTextInputType({ concreteEntityAdapter, composer, }) {
...
export function withFullTextWhereInputType({ composer, concreteEntityAdapter, }) {
...
export function withFullTextSortInputType({ composer, concreteEntityAdapter, }) {
...
export function withFullTextResultType({ composer, concreteEntityAdapter, }) {
