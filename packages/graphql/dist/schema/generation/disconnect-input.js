...
export function withDisconnectInputType({ entityAdapter, composer, }) {
...
export function augmentDisconnectInputTypeWithDisconnectFieldInput({ relationshipAdapter, composer, deprecatedDirectives, }) {
...
export function withDisconnectFieldInputType({ relationshipAdapter, composer, ifUnionMemberEntity, }) {
...
function makeDisconnectFieldInputTypeFields({ relationshipAdapter, composer, ifUnionMemberEntity, }) {
    ...
    if (relationshipAdapter.target instanceof ConcreteEntityAdapter) {
        ...
        if (relationshipTargetHasRelationshipWithNestedOperation(relationshipAdapter.target, RelationshipNestedOperationsOption.DISCONNECT)) {
