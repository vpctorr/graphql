...
export function withConnectInputType({ entityAdapter, composer, }) {
...
export function augmentConnectInputTypeWithConnectFieldInput({ relationshipAdapter, composer, deprecatedDirectives, }) {
...
export function withConnectFieldInputType({ relationshipAdapter, composer, ifUnionMemberEntity, }) {
...
function makeConnectFieldInputTypeFields({ relationshipAdapter, composer, ifUnionMemberEntity, }) {
    ...
    if (relationshipAdapter.target instanceof ConcreteEntityAdapter) {
        ...
        if (relationshipTargetHasRelationshipWithNestedOperation(relationshipAdapter.target, RelationshipNestedOperationsOption.CONNECT)) {
