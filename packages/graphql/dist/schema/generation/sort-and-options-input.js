...
export function withOptionsInputType({ entityAdapter, userDefinedFieldDirectives, composer, }) {
...
export function withSortInputType({ relationshipAdapter, userDefinedFieldDirectives, composer, }) {
    ...
    for (const attribute of relationshipAdapter.attributes.values()) {
        ...
        const deprecatedDirective = userDefinedDirectivesOnField.filter((directive) => directive.name.value === DEPRECATED);
