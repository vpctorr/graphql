...
export function generateSubscriptionTypes({ schemaComposer, schemaModel, userDefinedFieldDirectivesForNode, generateRelationshipTypes, features, }) {
    ...
    const nodeNameToEventPayloadTypes = allNodes.reduce((acc, entityAdapter) => {
        ...
        acc[entityAdapter.name] = schemaComposer.createObjectTC({
            ...
            fields: attributeAdapterToComposeFields(entityAdapter.subscriptionEventPayloadFields, userDefinedFieldDirectives),
        });
        return acc;
    }, {});
