...
function createSetRelationshipPropertiesAndParams({ properties, varName, relationship, operation, callbackBucket, }) {
    const strs = [];
    const params = {};
    const propertiesObj = relationship.properties && properties[relationship.properties]
    ...
    relationship.primitiveFields.forEach((field) => addCallbackAndSetParam(field, varName, propertiesObj, callbackBucket, strs, operation));
