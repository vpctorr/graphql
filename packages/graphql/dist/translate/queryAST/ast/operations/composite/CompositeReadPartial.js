...
export class CompositeReadPartial extends ReadOperation {
    ...
    transpileNestedCompositeRelationship(entity, context) {
        ...
        const clause = Cypher.concat(...extraMatches, ...filterSubqueries, matchClause, ...authFilterSubqueries, subqueries, ...sortSubqueries, ret);
        return {
            clauses: [clause],
    ...
    transpileTopLevelCompositeEntity(context) {
        ...
        const subqueries = Cypher.concat(...this.getFieldsSubqueries(nestedContext), ...cypherFieldSubqueries);
        const ret = this.getProjectionClause(nestedContext, context.returnVariable);
        const clause = Cypher.concat(...extraMatches, ...filterSubqueries, matchClause, ...authFilterSubqueries, subqueries, ret);
        return {
            clauses: [clause],
