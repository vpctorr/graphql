...
import { createAuthorizationAfterPredicateField, createAuthorizationAfterPredicate, } from "../create-authorization-after-predicate";
...
export function createAuthorizationAfterAndParams({ context, nodes, operations, indexPrefix, }) {
...
export function createAuthorizationAfterAndParamsField({ context, nodes, operations, indexPrefix, }) {
    const nodeMap = stringNodeMapToNodeMap(nodes);
