...
export function matchMathField(graphQLFieldName) {
...
export function mathDescriptorBuilder(value, entity, fieldMatch) {
...
export function buildMathStatements(mathDescriptor, scope, withVars, param) {
